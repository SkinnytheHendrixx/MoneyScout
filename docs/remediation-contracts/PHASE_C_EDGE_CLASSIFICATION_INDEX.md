...
**Status:** ACTIVE / MECHANICALLY RECONCILED AND POINTER-AUDITED THROUGH C-40  
**Frozen inventory authority:** `CROSS_REFERENCE_EDGE_INVENTORY.md`  
**Inventory size:** 163 directed edges  
**Classified through C-40:** 143  
**Unclassified after C-40:** 20  
...
## Mechanical checks through C-40

- Frozen inventory count: **163**.
- Batch edge occurrences C-01 through C-40: **143**.
- Unique classified edges: **143**.
- Duplicate classified edges: **0**.
- Classified edges absent from frozen inventory: **0**.
- Frozen inventory edges not yet classified: **20**.
- Section-pointer accuracy: **143 / 143 verified**.
- Section pointers resolving to the wrong edge: **0**.

### Full pointer audit through C-40
...
Batch C-40 was resolved directly against the committed batch file:
- `C40-01 = R7 → R4`;
- `C40-02 = R5 → R7`;
- `C40-03 = R7 → R5`;
- `C40-04 = R7 → R13`;
...
Cumulative result:
- **143 classified pointers checked**;
- **143 pointers resolve to the exact indexed edge**;
...
| `R5` | `R3=C39-02`; `R4=U`; `R6=C06-02`; `R7=C40-02`; `R11=C37-03`; `R20=C13-01` |
...
| `R8` | `R6=U`; `R7=C37-02`; `R12=C22-03`; `R13=C40-06`; `R14=C02-02`; `R15=C07-02`; `R16=C19-01`; `R20=C11-03` |
...
| `R11` | `R4=U`; `R5=C27-02`; `R6=C31-01`; `R7=C40-08`; `R8=C21-03`; `R9=C33-01`; `R10=C30-03`; `R12=C04-02`; `R13=C36-03`; `R14=C09-01`; `R20=C10-02` |
...
- `R7 → R4` → `C40-01` / `PHASE_C_BATCH_40.md`.
- `R5 → R7` → `C40-02` / `PHASE_C_BATCH_40.md`.
- `R7 → R5` → `C40-03` / `PHASE_C_BATCH_40.md`.
- `R7 → R13` → `C40-04` / `PHASE_C_BATCH_40.md`.
- `R13 → R7` → `C40-05` / `PHASE_C_BATCH_40.md`.
- `R8 → R13` → `C40-06` / `PHASE_C_BATCH_40.md`.
- `R13 → R8` → `C40-07` / `PHASE_C_BATCH_40.md`.
- `R11 → R7` → `C40-08` / `PHASE_C_BATCH_40.md`.
- `R17 → R7` → `C40-09` / `PHASE_C_BATCH_40.md`.
- `R19 → R7` → `C40-10` / `PHASE_C_BATCH_40.md`.
...
The section-pointer check is logically independent from the count checks. A mapping can preserve 163/143/20 arithmetic while still sending a reviewer to the wrong adjudication text; that state is a reconciliation failure.
