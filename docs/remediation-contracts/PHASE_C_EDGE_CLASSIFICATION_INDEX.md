...
**Status:** ACTIVE / MECHANICALLY RECONCILED AND POINTER-AUDITED THROUGH C-27  
**Frozen inventory authority:** `CROSS_REFERENCE_EDGE_INVENTORY.md`  
**Inventory size:** 163 directed edges  
**Classified through C-27:** 81  
**Unclassified after C-27:** 82  
...
## Mechanical checks through C-27

- Frozen inventory count: **163**.
- Batch edge occurrences C-01 through C-27: **81**.
- Unique classified edges: **81**.
- Duplicate classified edges: **0**.
- Classified edges absent from frozen inventory: **0**.
- Frozen inventory edges not yet classified: **82**.
- Section-pointer accuracy: **81 / 81 verified**.
- Section pointers resolving to the wrong edge: **0**.

### Full pointer audit through C-27
...
- **81 classified pointers checked**;
- **81 pointers resolve to the exact indexed edge**;
...
| `R9` | `R4=U`; `R7=U`; `R8=U`; `R10=C02-03`; `R11=U`; `R17=C23-02`; `R19=C12-02`; `R20=C18-03` |
...
| `R14` | `R7=U`; `R8=U`; `R10=C05-02`; `R11=U`; `R12=C27-03`; `R13=C19-02`; `R20=C15-03` |
| `R15` | `R7=U`; `R8=U`; `R11=C16-03`; `R16=C03-01`; `R19=C10-03`; `R20=C17-03` |
| `R16` | `R7=U`; `R8=U`; `R11=C18-01`; `R15=C25-03`; `R19=U`; `R20=C12-03` |
| `R17` | `R4=U`; `R5=C24-02`; `R7=U`; `R8=U`; `R9=U`; `R10=U`; `R15=U`; `R16=C20-01`; `R18=C09-02`; `R19=C03-02`; `R20=C14-02` |
| `R18` | `R5=U`; `R6=U`; `R7=U`; `R8=U`; `R11=C25-02`; `R14=C10-01`; `R20=C04-03` |
| `R19` | `R4=U`; `R7=U`; `R8=U`; `R9=U`; `R10=U`; `R11=U`; `R14=C14-03`; `R15=U`; `R16=C05-03`; `R17=C21-02`; `R18=C26-02`; `R20=C08-03` |
| `R20` | `R3=U`; `R4=C24-01`; `R6=U`; `R7=U`; `R8=U`; `R9=C25-01`; `R10=C27-01`; `R11=U`; `R14=U`; `R15=U`; `R16=U`; `R17=C03-03`; `R18=C21-01`; `R19=C23-01` |
...
The section-pointer check is logically independent from the count checks. A mapping can preserve 163/81/82 arithmetic while still sending a reviewer to the wrong adjudication text; that state is now a reconciliation failure.
