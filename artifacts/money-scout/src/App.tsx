...
import AssetFactoryPage from "@/pages/asset-factory";
    ...
    <Layout user={user} onLogout={onLogout}>
      <RoutedErrorBoundary>
        <Switch>
          ...
          <Route path="/factory" component={AssetFactoryPage} />
    ...
    <div className="min-h-[100dvh] grid place-items-center bg-muted/30 p-6">
      <div className="w-full max-w-md rounded-xl border bg-card p-8 shadow-sm">
        ...
        <p className="mt-3 text-sm leading-6 text-muted-foreground">
          Your account is signed in, but it is not on the Money Scout access
          list.
        </p>
        <button
          type="button"
