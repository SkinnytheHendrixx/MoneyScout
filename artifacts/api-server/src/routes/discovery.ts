...
const toApiRun = (run: typeof discoveryRunsTable.$inferSelect) => ({
  ...
  min_observed_total: run.minObservedTotal,
  ...
  total_drift: run.totalDrift,
  request_count: run.requestCount,
  network_attempt_count: run.networkAttemptCount,
  max_network_attempts: run.maxNetworkAttempts,
